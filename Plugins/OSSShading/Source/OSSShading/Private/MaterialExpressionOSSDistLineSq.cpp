...
#include "MaterialExpressionOSSDistLineSq.h"

#define LOCTEXT_NAMESPACE "UMaterialExpressionOSSDistLineSq"

UMaterialExpressionOSSDistLineSq::UMaterialExpressionOSSDistLineSq(const FObjectInitializer& ObjectInitializer)
...
int32 UMaterialExpressionOSSDistLineSq::Compile(class FMaterialCompiler* Compiler, int32 OutputIndex, int32 MultiplexIndex)
{
    ...
    */
    ...
    const int32 r = Compiler->Sub(pa, Compiler->Mul(ba, h));
    return Compiler->Dot( r, r );
}

void UMaterialExpressionOSSDistLineSq::GetCaption(TArray<FString>& OutCaptions) const
{
    FString ret = TEXT("DistLineSq");
    OutCaptions.Add(ret);
}
