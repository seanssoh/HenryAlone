...
class UMaterialExpressionOSSCustom : public UMaterialExpression
{
    ...
    UMaterialExpressionOSSCustom(const FObjectInitializer& ObjectInitializer);
...
#if WITH_EDITOR
    virtual FString GetDescription() const override { FString ret = TEXT("Custom"); return ret; }
    virtual void GetExpressionToolTip(TArray<FString>& OutToolTip) override { FString ret = TEXT("Custom"); OutToolTip.Add(ret); }
#endif
